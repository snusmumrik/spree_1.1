module Spree
  ...
  module ProductFilters
    ...
    def ProductFilters.price_filter
      ...
      conds = [ [ I18n.t(:under_price, :price => format_price(100))   , v[:price].lteq(100)],
                [ "#{format_price(100)} - #{format_price(200)}"        , v[:price].in(100..200)],
                [ "#{format_price(200)} - #{format_price(300)}"        , v[:price].in(200..300)],
                [ "#{format_price(300)} - #{format_price(400)}"        , v[:price].in(300..400)],
                [ I18n.t(:or_over_price, :price => format_price(400)) , v[:price].gteq(400)]]
